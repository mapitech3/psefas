...
class error_layer(object):
    ...
    def onSelChange(self, selection):
        ...
        mxd = arcpy.mapping.MapDocument(r'C:\Users\Administrator\Desktop\medad\python\Work\Mpy\Test_Start_proc\Tamplate\EditTazar.mxd')
