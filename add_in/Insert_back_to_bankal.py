...
Current = 'CURRENT'
# Current     = r'C:\Users\Administrator\Desktop\medad\python\Work\Mpy\Tazar_For_run\EditTazar89690\EditTazar89690.mxd' # test
...
if passWord == '123456':
    ...
    print_arcpy_message("password is not correct",2)
    sys.exit(1)
    

mxd      = arcpy.mapping.MapDocument(Current)
df      = arcpy.mapping.ListDataFrames(mxd, "Layers")[0]
print_arcpy_message(arcpy.mapping.ListLayers(mxd,"קווים להכנסה", df))
...
# Update_Large_Layers (point_Final,NODE_ALL_EDIT,AOI_Final)